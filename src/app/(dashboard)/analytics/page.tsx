  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-5">
        <div>
          ...
          <p className="text-sm mt-0.5" style={{ color: "var(--color-text-secondary)" }}>
            Data-driven insights into your job search
          </p>
        </div>
      </div>
      ...
      <div className="flex flex-col items-center justify-center py-16 rounded-lg"
        ...
        <h3 className="text-sm font-medium text-white mb-1">Analytics Dashboard</h3>
        <p className="text-xs max-w-xs text-center" style={{ color: "var(--color-text-secondary)" }}>
          Visualize response rates, interview rates, resume performance, and more.
        </p>
