    ...
    <div>
      <div className="flex items-center justify-between mb-5">
        <div>
          ...
          <p className="text-sm mt-0.5" style={{ color: "var(--color-text-secondary)" }}>
            Track deadlines, interviews, and important dates
          </p>
        </div>
      </div>
      ...
      <div className="flex flex-col items-center justify-center py-16 rounded-lg"
        ...
        <div className="w-10 h-10 rounded-md flex items-center justify-center mb-3"
          ...
          <CalendarIcon className="w-5 h-5" style={{ color: "var(--color-accent-primary)" }} />
        </div>
        <h3 className="text-sm font-medium text-white mb-1">Calendar view</h3>
        <p className="text-xs max-w-xs text-center" style={{ color: "var(--color-text-secondary)" }}>
          Integrated calendar with application dates, deadlines, and interview schedules.
        </p>
